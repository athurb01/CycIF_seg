...
imageDirectory = '/n/groups/lsp/AmyT/FI17/FI17_registered/';
saveDirectory = '/n/groups/lsp/AmyT/FI17/FI17_mat_output/';
experiment = 'FI17_';
mag = '';
maxCycle = 9; 
FOVlimits = [1,1,2,5,3,7,1,1]; % array of  timepoint, row, column, and field start/stop
...
channelNames = { 'Hoechst1', 'Hoechst2', 'Hoechst3',...
    ...
    'Nos2', 'Arg-1', 'Lamp1','Ki67',...
    'mTB_mCherry_Z','mTB_mCherry_slice', 'p_STAT1', 'p_ERK', 'CD68',...
    'cPARP', 'HMGB1', 'actin', 'cCas3',...
    'cy5none', 'p50', 'LC3', 'CD80', 'RelA', 'p_mTOR', 'p_STAT3',...
    'PDL1', 'p_STAT6'};

bugGFP = [(maxCycle + 1), (maxCycle + 2)]; %channel number bug GFP signal
bugmCherry = [(2*maxCycle + 1), (2*maxCycle + 2)]; %channel number bug mCherry signal
punctaChannels = [14,30]; %channels to be analyzed for puncta
