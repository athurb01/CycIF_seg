...
imageDirectory = '/n/scratch2/aet13/FI20/FI20_registered/';
saveDirectory = '/n/scratch2/aet13/FI20/FI20_output/';
experiment = 'FI20_';
mag = '';
maxCycle = 10; 
FOVlimits = [1,4,2,4,2,9,1,4]; % array of  timepoint, row, column, and field start/stop
...
channelNames = { 'Hoechst1', 'Hoechst2', 'Hoechst3',...
    ...
    'Nos2', 'Arg-1', 'Lamp1','Ki67','Rel_zen',...
    'mTB_mCherry_Z','mTB_mCherry_slice', 'p_STAT1', 'cyt_c', 'p_ERK',...
    'CD68', 'HMGB1', 'actin', 'cCas3', 'cPARP',...
    'cy5none', 'p50', 'LC3', 'IRF1', 'CD80', 'RelA', 'p_mTOR', 'p_STAT3',...
    'PDL1', 'p_STAT6'};
